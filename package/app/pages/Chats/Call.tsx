        ...
        <SafeAreaView style={{ backgroundColor: '#112036', flex: 1 }}>
            <View style={GlobalStyleSheet.container}>
                ...
                <View style={{ paddingTop: 30, alignItems: 'center' }}>
                    <Text style={{ ...FONTS.fontSemiBold, ...FONTS.h3, color: COLORS.white }}>Mr. {data.title}</Text>
                    <Text style={{ ...FONTS.h4, ...FONTS.fontMedium, color: COLORS.white, opacity: .4, marginTop: 20 }}>00:20</Text>
                </View>
