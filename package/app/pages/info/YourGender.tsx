...
type YourGenderScreenProps = NativeStackScreenProps<RootStackParamList, 'YourGender'>;

const YourGender = ({ navigation } : YourGenderScreenProps) => {
                ...
                <View style={{flex:1,paddingTop:STATUSBAR_HEIGHT}}>
                    ...
                    >
                        ...
                        <View style={[GlobalStyleSheet.container,{paddingTop:50}]}>
                            <Text style={[FONTS.fontBold,{fontSize:25,color:theme.dark ? colors.title : '#191919'}]}>What's your gender ?</Text>
